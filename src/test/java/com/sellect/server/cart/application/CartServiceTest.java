...
//            // Given
//            User user = User.builder().id(userId).build();
//            CartItem cartItem = CartItem.add(user, productRepository.findById(productId).orElseThrow());
...
//            // Given
//            User user = User.builder().id(userId).build();
//            cartItemRepository.save(CartItem.add(user, productRepository.findById(productId)));
//
//            // When & Then
